    ...
    return (
        <div>
            <div className="movies-display-details">
                <div className="movie-backdrop" style={{backgroundImage: `url(${image})`}}></div>
                    <div>
                        <div className="movie-details">{details.original_title}</div>
                        <div className="movie-description">{details.overview}</div>
                        <div className="movie-description">Release date: {details.release_date}</div>
                            ...
                            <div className="genre">
                                {
                                    this.state.genres.map((genre, key) => {
                                        return (
                                            <div className="space-genre" key={key}>{genre.name}</div>
                                        )
                                    })
